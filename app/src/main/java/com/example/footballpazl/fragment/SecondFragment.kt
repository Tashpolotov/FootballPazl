...
import com.example.footballpazl.databinding.FragmentSecondBinding
import com.example.footballpazl.viewmodel.PhotoViewModel
import com.example.utils.Puzzles
import com.example.utils.TouchListener
...
class SecondFragment : Fragment() {
    ...
    private var pieces: java.util.ArrayList<Puzzles?>? = null
    private var mCurrentPhotoPath: String? = null
    private var mCurrentPhotoUri: String? = null
    private var isGameFinished = false
    val userChoice :String? = null
    private var assembledPhoto: Bitmap? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val assetName = bundle?.getString("assetName")
    ...
    private fun splitImage(): java.util.ArrayList<Puzzles?> {
        val piecesNumber = 12
        val rows = 4
        val cols = 3
        ...
        for (row in 0 until rows) {
            ...
            for (col in 0 until cols) {
                ...
                val piece = Puzzles(requireContext())
    ...
    fun checkGameOver() {
        if (isGameOver) {
            assembledPhoto = (binding.imageView.drawable as BitmapDrawable).bitmap
            Log.d("PhotoViewModel", "assembledPhoto saved: $assembledPhoto")


            val btnMoreInfo = requireView().findViewById<MaterialButton>(R.id.btn_more_info)
